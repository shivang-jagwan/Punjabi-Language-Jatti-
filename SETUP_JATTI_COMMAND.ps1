...
$jattiPath = "__JATTI_PATH_PLACEHOLDER__"
function jatti {
...
# Replace placeholder with the folder that contains this setup script (portable)
$jattiFunction = $jattiFunction.Replace("__JATTI_PATH_PLACEHOLDER__", $PSScriptRoot)
